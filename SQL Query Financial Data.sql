...
LOAD DATA INFILE 'C:\Users\ashish yadav\Desktop\BI Project\Credit_Card_Financial_Dashboard-main\credit_card.csv'
INTO TABLE cc_detail
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES; -- If your CSV file contains a header row


COPY cc_detail
FROM 'C:\Users\ashish yadav\Desktop\BI Project\Credit_Card_Financial_Dashboard-main\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\ashish yadav\Desktop\BI Project\Credit_Card_Financial_Dashboard-main\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'C:\Users\ashish yadav\Desktop\BI Project\Credit_Card_Financial_Dashboard-main\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\ashish yadav\Desktop\BI Project\Credit_Card_Financial_Dashboard-main\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
